...
public class AvailableTableService {
    ...
    // 訂位成功後，扣減大桌數量
    public void decreaseLargeTableCount(LocalDate date, Integer sessionId) { // 👈 換成 LocalDate
    ...
    // 訂位成功後，扣減小桌數量
    public void decreaseSmallTableCount(LocalDate date, Integer sessionId) { // 👈 換成 LocalDate
        AvailableTableVO vo = getOneAvailableTable(date, sessionId);
